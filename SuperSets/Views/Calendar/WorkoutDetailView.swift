...
//
// Full details of a past completed workout.
//
// v2.0 — 10x LIQUID GLASS: Deep glass stat tiles, glass gem icons,
// glass rows for exercise sets. All .glassCard() auto-upgraded to slabs.
...
struct WorkoutDetailView: View {
    ...
    /// Stat tile — deep glass for glass-on-glass effect.
