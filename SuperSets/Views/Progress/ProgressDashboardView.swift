...
struct ProgressDashboardView: View {
    ...
    /// Derived count of completed workouts — used to detect isActive flips.
    ...
    var body: some View {
        ...
        .onChange(of: completedCount) { _, _ in
            // Force refresh when the number of completed workouts changes
            // (catches isActive flip that .onChange(of: allWorkouts) may miss)
            refreshData()
        }
